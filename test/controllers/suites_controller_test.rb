...
class SuitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suite" do
    assert_difference('Suite.count') do
      post suites_url, params: { suite: { custom_params: @suite.custom_params, description: @suite.description, name: @suite.name } }
    end
  ...
  test "should update suite" do
    patch suite_url(@suite), params: { suite: { custom_params: @suite.custom_params, description: @suite.description, name: @suite.name } }
