...
class VersionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post versions_url, params: { version: { description: @version.description, name: @version.name, vcs: @version.vcs } }
    end
  ...
  test "should update version" do
    patch version_url(@version), params: { version: { description: @version.description, name: @version.name, vcs: @version.vcs } }
